...
export function Select({ label = '', options = [], value, defaultValue, disabled = false, style = {}, ...rest }) {
      ...
      <span style={{ position: 'relative', display: 'block' }}>
        <select
          ...
          style={{
            ...
            outline: 'none', cursor: 'pointer', opacity: disabled ? 0.55 : 1, ...style,
          }}
        ...
        <span style={{ position: 'absolute', right: 14, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none', color: 'var(--accent-strong)' }}>
